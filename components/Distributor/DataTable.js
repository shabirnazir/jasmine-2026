...
const DataTable = (props) => {
  const { data = [], distributor, year } = props;
      ...
      <div className={css.mobileCards}>
        {paginatedData?.map((item, index) => (
          ...
          >
            ...
            <div className={css.tableCardRow}>
              <span className={css.tableCardLabel}>Chalan No.</span>
              <span className={css.tableCardValue}>{item?.chalan || "-"}</span>
            </div>
            <div className={css.tableCardRow}>
              <span className={css.tableCardLabel}>Detail</span>
              <span className={css.tableCardValue}>{item.detail || "-"}</span>
            </div>
            <div className={css.tableCardRow}>
